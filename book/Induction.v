...
Proof.
  induction n as [| n' IHn'].
  - intros m. rewrite plus_O_n. rewrite <- plus_n_O. reflexivity.
...
Proof.
  ...
  - simpl. rewrite Hleb. reflexivity.
...
Fixpoint nat_to_bin (n0: nat) : bin :=
  match n0 with
  | O => BO
...
Theorem nat_to_bin__bin_to_nat : forall n: nat,
